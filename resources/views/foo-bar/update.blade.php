    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Update Foo Bar</div>
                <div class="panel-body">
                   	<form ng-submit="vm.updateFooBar()" name="fooBarForm">
                        <div ng-if="vm.message.length" data-ng-bind="vm.message" class="alert alert-info"></div>
                          <div class="form-group">
                            ...
                            <input ng-model="vm.fooBar.foo_bar_name" name="fooBarName" required type="text" class="form-control" id="foo-bar-name" placeholder="Foo Bar Name">
...
<script>
  window.fooBar = {!! json_decode($fooBar) !!};
</script>
@endsection